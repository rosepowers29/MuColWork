...
for file in to_process:
    ...
    for ievt, event in enumerate(reader):
       ...
       ''' 
        ...
        try:
            HCalhits_endcap = event.getCollection(HcalEndcapCollectionConed)
        except:
            print("Failure to get HcalEndcapCollectionConed")
        try:
            HCalhits_barrel = event.getCollection(HcalBarrelCollectionConed)
        except:
            print("Failure to get HcalBarrelCollectionConed")
        ...
        for icoll, coll in enumerate(hcal_coll):
            ...
            try:
                ...
                for hit in HCALhitCollection:
                    ...
                    Hhit_eta[0] = hit_vec.Eta()
                    Hhit_phi[0] = hit_vec.Phi()
                    Hhit_depth[0] = layer
